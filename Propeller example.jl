#First converge Ct, Cq, n (Look at graphs at bottom) (choose Cq (coefficient of torque))
#Then look at velocity profiles some time downstream
# Meeting with Ben at 9AM
...
# Time parameters
nrevs           = 4       #Essential wakelength start with this. AFFEECTS RESOLUTION                # Number of revolutions in simulation
nsteps_per_rev  = 36       #time steps. AFFECTS RESOLUTION                # Time steps per revolution
...
p_per_step      = 2      #AFFECTS RESOLUTION                 # Sheds per time step
#p_per_step   = ceil((lambda_vpm * 2*pi)/(nsteps_per_rev*(1/n)))                 #when changing other values to make things better.
